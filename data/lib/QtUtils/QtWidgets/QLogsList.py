...
class QLogsList(QBetterListWidget):
    ...
    def init(app: QBaseApplication) -> None:
        ...
        QLogsList._info_icon = app.get_icon('logslist/info.png', True, app.save_data.IconMode.Global)
        QLogsList._warning_icon = app.get_icon('logslist/warning.png', True, app.save_data.IconMode.Global)
        QLogsList._error_icon = app.get_icon('logslist/error.png', True, app.save_data.IconMode.Global)
        QLogsList._success_icon = app.get_icon('logslist/success.png', True, app.save_data.IconMode.Global)
