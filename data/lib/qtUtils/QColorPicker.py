...
class QColorPicker(QGridFrame):
    ...
    def _create_color_view(self) -> None:
        ...
        self.grid_layout.addWidget(self._color_view, 0, 0)
        self.grid_layout.addWidget(self._black_overlay, 0, 0)
        self.grid_layout.addWidget(self._color_view, 0, 0)
    ...
    def _create_color_slider(self) -> None:
        ...
        self.grid_layout.addWidget(self._hue_frame, 0, 1)
        ...
        self.grid_layout.addWidget(self._hue_bg, 0, 1)
        self.grid_layout.setAlignment(self._hue_bg, Qt.AlignmentFlag.AlignCenter)
    ...
    def _create_alpha_slider(self) -> None:
        ...
        self.grid_layout.addWidget(self._alpha_frame, 0, 2)
        ...
        self.grid_layout.addWidget(self._alpha_bg, 0, 2)
        self.grid_layout.setAlignment(self._alpha_bg, Qt.AlignmentFlag.AlignCenter)
    ...
    def _create_color_input(self) -> None:
        ...
        frame.grid_layout.addWidget(self._color_vis, 0, 0)
        ...
        input_frame.grid_layout.addWidget(self._color_combobox, 0, 0)
        ...
        input_frame_bottom.grid_layout.addWidget(self._alpha_spinbox, 0, 1)


        self._rgb_frame = QGridFrame()
        self._rgb_frame.grid_layout.setContentsMargins(0, 0, 0, 0)
        self._rgb_frame.grid_layout.setSpacing(5)

        label = QLabel('R')
        label.setFixedWidth(20)
        self._rgb_frame.grid_layout.addWidget(label, 0, 0)
        self._rgb_red_spinbox = QSpinBox()
        self._rgb_red_spinbox.setRange(0, 255)
        # self._rgb_red_spinbox.setValue(self._color.red)
        self._rgb_frame.grid_layout.addWidget(self._rgb_red_spinbox, 0, 1)

        label = QLabel('G')
        label.setFixedWidth(20)
        self._rgb_frame.grid_layout.addWidget(label, 1, 0)
        self._rgb_green_spinbox = QSpinBox()
        self._rgb_green_spinbox.setRange(0, 255)
        # self._rgb_green_spinbox.setValue(self._color.green)
        self._rgb_frame.grid_layout.addWidget(self._rgb_green_spinbox, 1, 1)

        label = QLabel('B')
        label.setFixedWidth(20)
        self._rgb_frame.grid_layout.addWidget(label, 2, 0)
        self._rgb_blue_spinbox = QSpinBox()
        self._rgb_blue_spinbox.setRange(0, 255)
        # self._rgb_blue_spinbox.setValue(self._color.blue)
        self._rgb_frame.grid_layout.addWidget(self._rgb_blue_spinbox, 2, 1)

        self._rgb_frame.grid_layout.setRowStretch(3, 1)
        input_frame_top.grid_layout.addWidget(self._rgb_frame, 0, 0)


        self._hsv_frame = QGridFrame()
        self._hsv_frame.grid_layout.setContentsMargins(0, 0, 0, 0)
        self._hsv_frame.grid_layout.setSpacing(5)

        label = QLabel('H')
        label.setFixedWidth(20)
        self._hsv_frame.grid_layout.addWidget(label, 0, 0)
        ...
        self._hsv_frame.grid_layout.addWidget(self._hsv_hue_spinbox, 0, 1)

        label = QLabel('S')
        label.setFixedWidth(20)
        self._hsv_frame.grid_layout.addWidget(label, 1, 0)
        ...
        self._hsv_frame.grid_layout.addWidget(self._hsv_saturation_spinbox, 1, 1)

        label = QLabel('V')
        label.setFixedWidth(20)
        self._hsv_frame.grid_layout.addWidget(label, 2, 0)
        ...
        self._hsv_frame.grid_layout.addWidget(self._hsv_value_spinbox, 2, 1)

        self._hsv_frame.grid_layout.setRowStretch(3, 1)
        input_frame_top.grid_layout.addWidget(self._hsv_frame, 0, 0)
        self._hsv_frame.setVisible(False)


        self._hsl_frame = QGridFrame()
        self._hsl_frame.grid_layout.setContentsMargins(0, 0, 0, 0)
        self._hsl_frame.grid_layout.setSpacing(5)

        label = QLabel('H')
        label.setFixedWidth(20)
        self._hsl_frame.grid_layout.addWidget(label, 0, 0)
        self._hsl_hue_spinbox = QSpinBox()
        self._hsl_hue_spinbox.setRange(0, 360)
        # self._hsl_hue_spinbox.setValue(int(self._color.hue_hsl))
        self._hsl_frame.grid_layout.addWidget(self._hsl_hue_spinbox, 0, 1)

        label = QLabel('S')
        label.setFixedWidth(20)
        self._hsl_frame.grid_layout.addWidget(label, 1, 0)
        ...
        self._hsl_frame.grid_layout.addWidget(self._hsl_saturation_spinbox, 1, 1)

        label = QLabel('L')
        label.setFixedWidth(20)
        self._hsl_frame.grid_layout.addWidget(label, 2, 0)
        ...
        self._hsl_frame.grid_layout.addWidget(self._hsl_lightness_spinbox, 2, 1)

        self._hsl_frame.grid_layout.setRowStretch(3, 1)
        input_frame_top.grid_layout.addWidget(self._hsl_frame, 0, 0)
        self._hsl_frame.setVisible(False)


        self._cmyk_frame = QGridFrame()
        self._cmyk_frame.grid_layout.setContentsMargins(0, 0, 0, 0)
        self._cmyk_frame.grid_layout.setSpacing(5)

        label = QLabel('C')
        label.setFixedWidth(20)
        self._cmyk_frame.grid_layout.addWidget(label, 0, 0)
        ...
        self._cmyk_frame.grid_layout.addWidget(self._cmyk_cyan_spinbox, 0, 1)

        label = QLabel('M')
        label.setFixedWidth(20)
        self._cmyk_frame.grid_layout.addWidget(label, 1, 0)
        ...
        self._cmyk_frame.grid_layout.addWidget(self._cmyk_magenta_spinbox, 1, 1)

        label = QLabel('Y')
        label.setFixedWidth(20)
        self._cmyk_frame.grid_layout.addWidget(label, 2, 0)
        ...
        self._cmyk_frame.grid_layout.addWidget(self._cmyk_yellow_spinbox, 2, 1)

        label = QLabel('K')
        label.setFixedWidth(20)
        self._cmyk_frame.grid_layout.addWidget(label, 3, 0)
        ...
        self._cmyk_frame.grid_layout.addWidget(self._cmyk_key_spinbox, 3, 1)

        self._cmyk_frame.grid_layout.setRowStretch(4, 1)
        input_frame_top.grid_layout.addWidget(self._cmyk_frame, 0, 0)
        self._cmyk_frame.setVisible(False)


        self._hex_frame = QGridFrame()
        self._hex_frame.grid_layout.setContentsMargins(0, 0, 0, 0)
        self._hex_frame.grid_layout.setSpacing(5)

        label = QLabel('#')
        label.setFixedWidth(20)
        self._hex_frame.grid_layout.addWidget(label, 0, 0)
        self._hex_line_edit = QLineEdit()
        # self._hex_line_edit.setText(self._color.hex.replace('#', ''))
        self._hex_frame.grid_layout.addWidget(self._hex_line_edit, 0, 1)

        self._hex_frame.grid_layout.setRowStretch(1, 1)
        input_frame_top.grid_layout.addWidget(self._hex_frame, 0, 0)
