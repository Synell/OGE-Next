...
class QLogsDialog(QDialog):
    ...
    def __init__(self, parent = None):
        ...
        self.list_widget: QLogsList = QLogsList()
        frame.grid_layout.addWidget(self.list_widget, 0, 0)
    ...
    def add_info(self, message: str) -> None:
        self.list_widget.add_info(message)


    def add_warning(self, message: str) -> None:
        self.list_widget.add_warning(message)


    def add_error(self, message: str) -> None:
        self.list_widget.add_error(message)


    def add_success(self, message: str) -> None:
        self.list_widget.add_success(message)
#----------------------------------------------------------------------
