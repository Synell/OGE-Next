...
from PySide6.QtGui import QMouseEvent, QPainter, QWheelEvent, QPen, QBrush
...
class QBetterGraphicsView(QGraphicsView):
    class SelectedItem:
        def __init__(self, item: QGraphicsItem | QGraphicsProxyWidget, offset: QPoint) -> None:
        ...
        @offset.setter
        def offset(self, value: QPoint) -> None:
            self._offset = value
    ...
    def __init__(self, size: QRect, scene_cls: type[QBetterGraphicsScene] = QBetterGraphicsScene) -> None:
        ...
        self._move_mouse_origin_scene = QPoint()
    ...
    def items_at(self, pos: QPoint) -> list[QGraphicsItem]:
        return self._scene.items_at(pos)
    ...
    def wheelEvent(self, event: QWheelEvent) -> None:
        ...
        delta_viewport_pos = self._move_mouse_origin - QPoint(self.viewport().width() / 2.0, self.viewport().height() / 2.0)
        viewport_center = self.mapFromScene(self._move_mouse_origin_scene) - delta_viewport_pos
