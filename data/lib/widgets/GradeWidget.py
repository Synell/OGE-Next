...
class GradeWidget(OGEWidget):
    ...
    def __init__(self, grade: Grade) -> None:
        ...
        if grade.is_new:
            ...
            self.layout_.addWidget(iw, 0, self.layout_.count(), Qt.AlignmentFlag.AlignRight | Qt.AlignmentFlag.AlignVCenter)
        ...
        self.layout_.addWidget(label, 0, self.layout_.count())
